...
Sistema de agendamento de consultas e exames para o SUS (Sistema Único de Saúde), desenvolvido como MVP para o **Hackathon FIAP**. O projeto utiliza **Clean Architecture** e integra múltiplas fontes de dados mockadas para simular um ambiente realista de integração com sistemas do SUS.Sistema de agendamento de consultas para o SUS (Sistema Único de Saúde), desenvolvido como MVP para o Hackathon FIAP. O projeto utiliza Clean Architecture e integra múltiplas fontes de dados para simular um ambiente realista.
...
O projeto segue os princípios de **Clean Architecture**, separando responsabilidades em camadas:│   │   └── mapper/          # Mapeadores API -> Domain
